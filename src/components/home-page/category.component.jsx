...
const Course = () => {
  ...
  <div className = "w-[90%] mt-8">
    ...
    <h2 className="font-card-header text-[2.5rem] font-semibold font-card-header tracking-wide text-center">Placement Assured Courses</h2>
    <div className="w-[100%] h-auto flex gap-4 mt-[2rem]">
      <div className="w-[60%] flex flex-col gap-4">
        ...
        <div className="w-full flex gap-4 items-stretch">
          <div className="w-[50%] relative flex items-stretch overflow-hidden cursor-pointer">
          ...
          <div className="w-[50%] relative overflow-hidden cursor-pointer">
      ...
      <div className="w-[40%] flex items-stretch relative overflow-hidden cursor-pointer">
