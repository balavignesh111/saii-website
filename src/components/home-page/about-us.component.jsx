...
const About = () => {
  return ( 
    <div className="w-[90%] flex flex-col justify-between items-start gap-12 sm:flex-row sm:justify-between mt-8">
      <div className="w-[50%]">
        <img src={aboutImage} alt="about_image" className="w-100 h-100"/>
      </div>
      <div className="w-[50%] h-[100%] flex flex-col justify-between items-start gap-2">
        <h6 className="text-_blue font-semibold tracking-wide">ABOUT US</h6>
        <h2 className="text-[2.5rem] font-semibold font-card-header tracking-wide">Inspiring Innovations</h2>
